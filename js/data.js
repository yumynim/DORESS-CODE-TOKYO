...
window.SITE = {
  ...
  /* ▼ 出店者向け（toB）：申し込み・出店料のカード。
     ...
     - price          : 数字だけ（カンマ無しでOK）
     - note           : 補足（任意）
     - caution        : 目立たせたい注意書き（任意。赤字太字で表示される）
     - url            : 「今すぐ支払う」ボタンのリンク先（単品購入・従来の動線。catalogObjectId設定済みなら使われない）
  ...
  ticketsB: [
    {
      ...
      detail: [
        ...
        { heading: '出店者注意点', body: '・出店スペースは約2m×2m。\n・出店可能ジャンル：古着／オリジナルブランド／アクセサリー／雑貨／ZINE／ハンドメイド等。\n・お申し込みの流れ：\nまず「カートに追加」→ 画面右上のカートから「レジに進む」でお支払いください\n→ お支払い確認後、出店内容の確認が取れていない業者様に限り、ご入力用のフォームをお送りします。お手数ですがご入力・ご提出をお願いいたします\n→ イベント当日\n・屋内開催、雨天決行（会場内に試着室のご用意はございません）。' },
        { heading: '詳細・お問い合わせ', body: 'Instagram：@dress.code.tokyo\nイベントの詳細はInstagramをご確認ください。お問い合わせはこのホームページ下部のお問い合わせフォームからでも承っております。' },
      ],
    },
  ],
